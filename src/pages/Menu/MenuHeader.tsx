...
export default function MenuHeader() {
  ...
  function UnderlineSVG() {
    return (
      <div className="h-px w-25">
        ...
        >
          <rect width="100" height="2" x="0" y="0" fill="#7dd4e5" />
        </svg>
      </div>
    );
  }
  ...
  return (
    <div className="bg-[#eff7ff] pt-12 grid justify-center">
      <h1 className="text-center text-[#07344a] text-6xl tracking-wider font-extrabold mb-1">
        MENU
      </h1>
      ...
      <button
        className="bg-[#0b3d61] text-center font-fjalla-one text-white text-2xs tracking-wider my-3 mx-auto py-1 px-3"
      ...
      >
        <div className="grid grid-flow-row grid-cols-2 items-center justify-around h-full">
          <a
            ...
            className="bg-[#0b3d61] text-center text-white text-sm tracking-wider my-3 mx-auto py-1 px-3 rounded-md border-2 border-dark-navy"
          >
            SEATTLE
          </a>
          <a
      ...
      <div className="w-screen flex justify-around items-center px-2 bg-[#faf9f6]">
